using System;
using HarmonyLib;
using JunimoKartLevelSelect.Framework;
using JunimoKartLevelSelect.Framework.GMCM;
...
namespace JunimoKartLevelSelect
{
    internal sealed class ModEntry : Mod
    {
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            harmony.Patch(
               ...
               postfix: new HarmonyMethod(typeof(Framework.SelectLevelPatch), nameof(Framework.SelectLevelPatch.ShowMapPostfix))
            );
        ...
        private void SetupConfig(object? sender, EventArgs e)
        {
            ...
            configMenu.AddBoolOption(
                ...
                tooltip: () => "Unlock all levels when playing Junimo Kart in progress mode"
            );
        }
    }
}